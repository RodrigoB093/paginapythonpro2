...
@app.route("/index")
def hello_world():
    return '<h1>Hello, World!</h1> <a href="/random_fact">¡Ver un dato aleatorio!</a> <a href="/passgen">¡Generar una contraseña aleatoria!</a>'

@app.route("/passgen")
def passgen():
    passwordgen = gen_pass()
    return f'<h1>Random Password:</h1> <p>{passwordgen}</p>'
